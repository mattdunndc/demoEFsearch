namespace NRPTmodel
{
    ...
    public partial class BasicDbContext : DbContext
    {
        ...
        public virtual DbSet<t_usaa_app_access> t_usaa_app_access { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<t_usaa_app_access>()
                .Property(e => e.usaa_user_id)
                .IsUnicode(false);

            modelBuilder.Entity<t_usaa_app_access>()
                .Property(e => e.usaa_app_active_in)
                .IsFixedLength()
                .IsUnicode(false);

            modelBuilder.Entity<t_usaa_app_access>()
                .Property(e => e.usaa_preference_tx)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<t_user>()
                .HasMany(e => e.t_usaa_app_access)
                .WithRequired(e => e.t_user)
                .HasForeignKey(e => e.usaa_user_id)
                .WillCascadeOnDelete(false);
